...
This fork builds via [GitHub Actions](https://github.com/peakflames/SharpBucket/actions), on every push and pull request to `develop` and `main`. Releases to NuGet are published via a separate workflow — see `CONTRIBUTING.md`.
